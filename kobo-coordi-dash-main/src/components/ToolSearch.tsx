...
export const ToolSearch = () => {
  ...
  const handleConfirmStop = async () => {
    ...
    try {
      ...
      const csvApiUrl = `${process.env.NEXT_PUBLIC_AZURE_FUNCTION_BASE}/api/score_kobo_tool?code=${process.env.NEXT_PUBLIC_AZURE_FUNCTION_KEY}&tool_id=${selectedTool.id}&calculation_method=${encodeURIComponent(calculationMethod)}&column_names=column_names`;
      ...
      // Switch to stopped tab after stopping
